...
public class ChatServer {
    ...
    private static void serverConfig() {
        ...
        if ("y".equalsIgnoreCase(Main.getStringInput("\n > Want to set a server password? (y/n): ", false, 1, 1))) {
            serverPassword = Main.getStringInput(" > Set password (4-77 chars): ", false, 4, 77);
        }
        ...
        String newRootPassword = Main.getStringInput(" > Enter password for root (10-77 chars): ", false, 10, 77);
